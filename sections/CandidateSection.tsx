            ...
            <SectionContainer>
                <div ref={ref}>
                    ...
                    <motion.p
                        ...
                        className="text-[16px] text-gray-500 text-center max-w-xl mx-auto mb-14 leading-relaxed"
                    >
                    ...
                    >
                        {stats.map((stat, i) => (
                            <motion.div
                                ...
                                className="text-center py-6 px-4 rounded-2xl bg-[#fefcf9]/60 border border-[#ede5db]/60"
                            >
                                <p className="text-[28px] md:text-[32px] font-bold text-gray-900 tracking-tight">{stat.value}</p>
                                <p className="text-[13px] text-gray-400 font-medium mt-1">{stat.label}</p>
                            </motion.div>
                        ))}
                    </motion.div>
                </div>
